...
/**************************************************
* ACTION draftcert(const name& creator, const string& type, const string& strid, const string& cname, const string& exid, const asset& tpot)
*  This action drafts a certificate, either production or csink.
*
* creator - authorised creator drafting cert
* type    - such as: "production" or "csink"
...
*/
ACTION carboncert::draftcert(const name& creator, const string& type, const string& strid, const string& cname, const string& exid, const asset& tpot) {
    checkfreeze();
...
void carboncert::_draftcert_p(const name& creator, const string& strid, const string& cname, const string& exid, const asset& tpot) {
    ...
    check(sUnit == "MT", "Tonne symbol specified is incorrect for this contract. ");
